      ...
      before_migrate do
        ...
        if deploy[:application_type] == 'rails'
          ...
          if deploy[:auto_npm_install_on_deploy]
            Chef::Log.info(OpsWorks::ShellOut.shellout("sudo su 'touch #{release_path}/logs/www.log; touch #{release_path}/logs/www.log;' 2>&1"))
            Chef::Log.info(OpsWorks::ShellOut.shellout("sudo su 'chown deploy:www-data #{release_path}/logs/www.log; chown deploy:www-data #{release_path}/logs/www.log;' 2>&1"))
